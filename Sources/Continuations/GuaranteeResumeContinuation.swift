...
public final class GuaranteeResumeContinuation<ResumeValue, ResumeFailureValue>: Continuation<ResumeValue, ResumeFailureValue> {
    @usableFromInline
    let defaultResumeValue: () -> ResumeValue
    ...
    @inlinable
    public init(
        defaultResumeValue: @escaping @autoclosure () -> ResumeValue,
